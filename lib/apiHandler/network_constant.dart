...
class NetworkConstantsUtil {
  ...
  static String updatePhone = 'users/mobile-update';
      //'users/update-mobile';
  ...
  'notifications?expand=createdByUser,refrenceDetails,isFollowing';
  ...
  static String reactPostUrl = 'posts/react';
  static String sharePostUrl = 'posts/share';
  static String viewCountUrl = 'posts/view-counter';
  ...
  static String updateBioData = 'users/bio-update';
  static String updateGenderData = 'users/gender-update';
  static String updateQualificationData = 'users/education-update';
  static String updateWebsiteData = 'users/website-update';
  static String privateModeUrl = 'users/profile-visibility';
