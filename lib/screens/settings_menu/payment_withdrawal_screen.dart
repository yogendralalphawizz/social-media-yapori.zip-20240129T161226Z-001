...
class PaymentWithdrawalState extends State<PaymentWithdrawalScreen> {
  ...
  withdrawBtn() {
    return InkWell(
      onTap: () {
        // if (int.parse((_settingsController.setting.value!.coinsValue * _userProfileManager.user.value!.coins).toStringAsFixed(0)) <
        //     int.parse(_settingsController.setting.value!.minWithdrawLimit
        //         .toString())) {
      ...
      child: Center(
        child: Container(
            ...
            color: AppColorConstants.themeColor,
            child: Center(
              child: BodyMediumText(LocalizationString.withdraw,
    ...
    return InkWell(
      ...
      child: Center(
        child: Container(
            ...
            color: AppColorConstants.themeColor,
            child: Center(
              child: BodyMediumText(LocalizationString.redeem,
                  color: AppColorConstants.whiteClr,
                  weight: TextWeight.medium),
            )).round(5).backgroundCard(),
      ),
