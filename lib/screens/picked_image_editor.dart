...
class PickedImageEditor extends StatelessWidget {
...
class _SingleImageEditorState extends State<SingleImageEditor> {
        ...
        body: GestureDetector(
          ...
          child: Center(
            child: SizedBox(
              ...
              // color: AppColorConstants.backgroundColor,
              height: currentImage.height.toDouble() < 270 ? 100 : currentImage.height / pixelRatio,
              // // currentImage.height * heightRatio,
              // // MediaQuery.of(context).size.height / heightRatio,
              // width: MediaQuery.of(context).size.width / pixelRatio,
                  /// pixelRatio,
              child: Screenshot(
  ...
  Future<void> loadImage(dynamic imageFile) async {
    ...
    print("loadImage imageFile : $imageFile");
    layers.clear();
    ...
    print("loadImage backgroundLayerData set");
