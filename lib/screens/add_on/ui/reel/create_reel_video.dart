...
import 'package:foap/screens/add_on/ui/reel/video_editor.dart';
...
class CreateReelScreen extends StatefulWidget {
  final bool? isScene;
  const CreateReelScreen({Key? key, this.isScene}) : super(key: key);
...
class _CreateReelScreenState extends State<CreateReelScreen>
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(() => GestureDetector(
                        onTap: () {
                          _createReelController.updateRecordingLength(20);
                          _initAnimation();
                        },
                        child: Container(
                          height: 30,
                          ...
                          child: const Center(child: BodySmallText('20s')),
                        ),
                      )),
                      const SizedBox(
                        height: 25,
                      ...
                      // Obx(() => GestureDetector(
                      //   onTap: () {
                      //     _createReelController.updateRecordingLength(60);
                      //     _initAnimation();
                      //   },
                      //   child: Container(
                      //     height: 30,
                      ...
                      //             ? AppColorConstants.themeColor
                      //             : AppColorConstants.backgroundColor),
                      //     child: const Center(child: BodySmallText('1m')),
                      //   ),
                      // )),
                   widget.isScene! ?
                   Column(
                     children: [
                       ...
                       Obx(() => GestureDetector(
                         onTap: () {
                           _createReelController.updateRecordingLength(300);
                           _initAnimation();
                         },
                         child: Container(
                           height: 30,
                           ...
                           decoration: BoxDecoration(
                               ...
                               color: _createReelController
                                   ...
                                   ? AppColorConstants.themeColor
                                   : AppColorConstants.backgroundColor),
                           child: const Center(child: BodySmallText('5m')),
                         ),
                       )),
                       const SizedBox(
                         height: 25,
                       ...
                       Obx(() => GestureDetector(
                         onTap: () {
                           _createReelController.updateRecordingLength(600);
                           _initAnimation();
                         },
                         child: Container(
                           height: 30,
                           ...
                           decoration: BoxDecoration(
                               ...
                               color: _createReelController
                                   ...
                                   ? AppColorConstants.themeColor
                                   : AppColorConstants.backgroundColor),
                           child: const Center(child: BodySmallText('10m')),
                         ),
                       ))
                     ],
                   )
  ...
  void stopRecording() async {
    ...
    // _createReelController.createReel(
    //     _createReelController.croppedAudioFile, file as RxList<Media>);
  }
