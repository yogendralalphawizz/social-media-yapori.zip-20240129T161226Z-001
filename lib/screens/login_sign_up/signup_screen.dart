...
class SignUpScreenState extends State<SignUpScreen> {
      ...
      body: SingleChildScrollView(
        child: GestureDetector(
          ...
          child:
            ...
            // ),
            Heading4Text(LocalizationString.signUpMessage,
                weight: TextWeight.bold, color: AppColorConstants.themeColor),
            SizedBox(
              ...
              text: TextSpan(
                children: <TextSpan>[
                  TextSpan(
                      ...
                      style: TextStyle(fontSize: FontSizes.b3, color: AppColorConstants.iconColor)),
                  TextSpan(
  ...
  addSignUpBtn() {
    return AppThemeButton(
      onPress: () {
        FocusScope.of(context).requestFocus(FocusNode());
        if(loginController.userNameCheckStatus == 1) {
          ...
          AppUtil.showToast(message: 'This username is already taken!, please set another!', isSuccess: false);
        }
      },
