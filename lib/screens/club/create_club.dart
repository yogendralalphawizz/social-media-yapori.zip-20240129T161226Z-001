      ...
      children: [
        ...
        Obx(() =>
            privacyTypeWidget(
                ...
                callback: () {
                  setState(() {
                    _createClubController.privacyType.value = 3;
                  });
    ...
    if (widget.club.id == null) {
      ...
      Get.to(() =>
          ChooseClubCoverPhoto(
            club: widget.club,
            privacyType: _createClubController.privacyType.value
          ));
    } else {
