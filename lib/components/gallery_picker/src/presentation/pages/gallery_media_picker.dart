...
import 'package:foap/components/gallery_picker/src/core/functions.dart';
...
class _GalleryMediaPickerState extends State<GalleryMediaPicker> {
  ...
  _getPermission() {
    GalleryFunctions.getPermission(
        setState,
        provider,
        widget.onlyImages
            ? RequestType.image
              ...
              Center(
                child: Container(
                  ...
                  child: SelectedPathDropdownButton(
                    ...
                    appBarIconColor:
                        widget.appBarIconColor ??  Colors.white,
                    appBarTextColor: widget.appBarTextColor ??  Colors.white,
                    albumTextColor: widget.albumTextColor ??  Colors.white,
                    albumDividerColor:
                        widget.albumDividerColor ?? Colors.white,
                          ...
                          builder: (BuildContext context, child) =>
                            ...
                            onAssetItemClick: (asset, index) async {
                              ...
                              GalleryFunctions.getFile(asset)
                                ...
                                print('object${asset.videoDuration}');
                                  provider.pickPath(PickedAssetModel(
                                    ...
                                    type: asset.typeInt == 1
                                        ? 'image'
                                        : 'video',
                                    videoDuration:asset.typeInt != 1 ? const Duration(seconds: 30) : asset.videoDuration,
