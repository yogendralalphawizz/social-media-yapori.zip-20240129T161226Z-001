...
class GalleryFunctions {
  ...
  static getPermission(
      setState, GalleryMediaPickerController provider, RequestType type) async {
    ...
    if (result.isAuth) {
      ...
      PhotoManager.addChangeCallback((value) {
        _refreshPathList(setState, provider, type);
      });
  ...
  static _refreshPathList(
      setState, GalleryMediaPickerController provider, RequestType type) {
