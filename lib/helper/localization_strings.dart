...
class LocalizationString {
  ...
  static String scene = 'Scene'.tr;
  static String clips = 'Clips'.tr;
  ...
  static String writeComment = 'Write a comment'.tr;
  ...
  static String profileMode = 'Private Mode'.tr;
  static String changeUserName = 'Change user name'.tr;
  static String email = 'Email'.tr;
  static String emailOrUsername = 'Email'.tr;
  ...
  static String pleaseEnterBioData = 'Please enter Bio Data'.tr;
  static String pleaseEnterGender = 'Please select gender'.tr;
  static String pleaseEnterQualification = 'Please enter qualification'.tr;
  static String pleaseEnterWebsite = 'Please enter Website links'.tr;

  static String paymentDetailUpdated = 'Payment detail is updated'.tr;
  static String bioDataUpdated = 'Bio Data is updated'.tr;
  static String genderUpdated = 'Gender is updated'.tr;
  static String qualificationUpdated = 'Qualification is updated'.tr;
  static String websiteUpdated = 'Website links is updated'.tr;
  static String profileVisibilityChanged = 'Profile Visibility changed'.tr;
  static String paymentDetailSetup = 'Payment detail setup'.tr;
  static String paymentDetail = 'Payment detail'.tr;
  static String bioData = 'Bio Data'.tr;
  static String paypalId = 'Paypal Id'.tr;
  static String gender = 'Gender'.tr;
  static String qualification = 'Qualification'.tr;
  static String websiteLinks = 'Website Links'.tr;
  ...
  static String addStory = 'Add story'.tr;
  ...
  static String addHighlight = ' Add Highlights'.tr;
  ...
  static String profession = 'Profession'.tr;
  ...
  static String searchUsers = 'Search users'.tr;
  static String searchUserGroup = 'Search Users/Groups'.tr;
  ...
  static String locationUpdatedSuccess = 'Location Updated Successful!'.tr;
  ...
  static String areYouSureToLeaveClub = 'Are you sure to leave the club?'.tr;
  ...
  static String sharePostStory = 'Share Posts on Story'.tr;
  static String sharePostOnTimeline = ' Share Posts on Timeline'.tr;
  static String sharePostsOnClips = 'Share Posts on Clips'.tr;

  static String sharePostOther = 'Share Posts on Other Platforms'.tr;
  ...
  static String searchMusic = 'Search music'.tr;
  ...
  static String requestJoin = 'Join Request'.tr;
  ...
  static String birthdaySubHeader =
      'Be accurate to specify this to get Gladescene matches'.tr;
  ...
  static String setProfileCategoryType = 'Choose profile profession'.tr;
